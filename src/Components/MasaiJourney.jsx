...
export default function MasaiJourney ( ) {
    ...
    return (
        ...
        <SimpleGrid columns={[2,2,4,4]}  w={{base :'90%',md : '95%', lg : '80%'}} m='auto' rowGap={{base : '20px'}} gap='20px'>
            <Box   bg={Theme === 'light' ? 'white' : 'black'} color={Theme === 'light' ? 'black' : 'white'}   border={{base :'2px solid #B794F4', md: '3px solid #B794F4', lg:'5px solid #B794F4'}}  textAlign='center' padding={{base : '10px', lg: '30px'}} width={{base: '85%', lg :'80%'}} m='auto' borderRadius='10px' shadow='lg'>
            ...
            <Box  bg={Theme === 'light' ? 'white' : 'black'} color={Theme === 'light' ? 'black' : 'white'}   border={{base :'2px solid #B794F4', md: '3px solid #B794F4', lg:'5px solid #B794F4'}} textAlign='center' padding={{base : '10px', lg: '30px'}}  width={{base: '85%',md: '90%', lg :'80%'}} m='auto' borderRadius='10px' shadow='lg'>
